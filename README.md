...
## [ExpressLRS RF Only Telemetry Widget (for fixed wing)](https://github.com/offer-shmuely/edgetx-x10-widgets/wiki/els_rf)
* Display **_RF Only_**  telemetry for fixed wing planes (i.e. line of site)
* Display rate/link quality/power/rssi1/rssi2
* Display min & max
* Display post flight summary (auto detection end-of-flight)
